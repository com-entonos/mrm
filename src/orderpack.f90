!this is orderpack 2.0 (http://www.fortran-2000.com/rank/orderpack.f90) from Michel Olagnon (Michel.Olagnon@polytechnique.org)
! we reordered some of the modules so no compiling errors occur
!
!below is email chain correspondence w/ Michel concerning license:
!Please use Michel.Olagnon@polytechnique.org, since I will be retiring  at the end of this year and don't know how long my Ifremer email is  going to work afterwards.
!
!Cheers,
!
!Michel
!
!!gjp@parker9.com a écrit :
!!
!!Michel-
!!
!!excellent. i'll include the download link and this email/address at  the top of the ORDERPACK 2.0 source code.
!!
!!thank you for your response,
!!
!!cheers,
!!
!!!On 2016-03-16 22:54, Michel.Olagnon@ifremer.fr wrote:
!!!Dear G.J. Parker,
!!!
!!!You may use Orderpack 2.0 as you wish, for any commercial or
!!!non-commercial application. The only restrictions are that you should
!!!neither claim that I would not have written the original version (yet
!!!you may modify the code to suit your needs), nor hold me responsible
!!!of any bugs or malfunctionning.
!!!It is a kind of Creative Commons license scheme, but there are some
!!!subtle restrictions in the wording of those licenses that I don't want
!!!to impose on the users.
!!!
!!!Best regards,
!!!
!!!Michel
...
!!!!Dear Dr. Olagnon:
!!!!
!!!!i would like to use your ORDERPACK 2.0 in a research tool for a   commercial company. unfortunately, i can not see what license is   imposed. would you please advise?
!!!!
